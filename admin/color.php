            ...
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                ...
                <table class="table display" id="colors" style="margin-top: 20px; width:100%">
                    <thead class="thead-dark" style="background-color: #e8eaf6; padding-top:2px;padding-bottom:5px;">
                        <tr>                   
                            <th width="30%" style="text-align: left;">Color</th>
                    ...
                    <tbody >
                        <?php
                            $sql = "SELECT color_id, color_name  FROM tbl_product_color";
                            ...
                            // if equal to current
                                echo '<tr>
                                    ...
                                    <td width="15%" style="text-align: left;"><a href="javascript:delete_id('.$row['color_id'].')"><button type="button" class="btn btn-danger fa fa-trash"></button></a></td>
                                </tr>';
                            }
                        ?>        
                    </tbody>
