        ...
        <table class="table display" id="products" style="margin-top: 20px; width:100%">
            <thead class="thead-dark" style="background-color: #e8eaf6; padding-top:2px;padding-bottom:5px;">
                <tr>                   
                    ...
                    <th width="9%" style="text-align: left;">User ID</th>
                    ...
                    { 
                        if ((in_array("admin", $_SESSION['access_role'], TRUE)))
                        {
                            ...
                            echo '<tr>
                                ...
                                <td width="9%" style="text-align: left;"><a href="user_address_details.php?user_id='.$row['user_id'].'">'.$row['user_id'].'</a></td>
                                ...
                                <td width="3%" style="text-align: left;"><a href="edit_order.php?id='.$row['order_id'].'"><button type="button" name="edit" class="btn btn-primary edit_data"><i class="fa fa-pencil"></i></button></a></td>
                                <td width="3%" style="text-align: left;"><button type="button" class="btn btn-danger fa fa-trash"></button></td>
                            </tr>';
                        }
                        else
                        {
